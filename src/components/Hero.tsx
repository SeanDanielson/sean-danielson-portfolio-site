...
export default function Hero() {
	return (
		<section
			id="top"
			className="relative overflow-hidden px-6 pt-16 pb-24 md:px-10 md:pt-24 md:pb-32"
		>
				...
				<div>
					...
					<Reveal delay={200}>
						<p className="text-balance mt-7 max-w-xl text-lg leading-relaxed text-ink-soft">
							Senior full-stack engineer with 4+ years building and modernizing
							financial software: production LLM pipelines, critical-path
							systems, and full-stack rewrites. Promoted to Senior at Blackbaud
							in three years.
						</p>
					</Reveal>

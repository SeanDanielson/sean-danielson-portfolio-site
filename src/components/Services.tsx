...
const SERVICES = [
  {
    ...
    body: "Full-stack web apps and internal products, built with React/Next.js on the frontend and Node or .NET on the backend, deployed wherever makes sense for your team. From a marketing site to a full application, built to last past launch.",
    icon: (
      <path

...
const ROLES = [
	{
		...
		subtitle: "Promoted from Software Engineer, May 2025",
		bullets: [
			...
			"Led the implementation of product's record level security, translating permissions between legacy and modern platforms on the critical path of every authenticated request.",
			...
			"Promoted to Senior in three years, recognized for end-to-end feature ownership and influence on platform design decisions.",
		],
	},
	{
